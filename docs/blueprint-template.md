...
- [REPO_URL]: https://github.com/Kaistory/Lab13-Observability
- [MEMBERS]:
...
- [EVIDENCE_LINK]: https://github.com/Kaistory/Lab13-Observability/commits/main — key files: `config/alert_rules.yaml`, `scripts/check_alerts.py`, `scripts/test_alerts.py`, `app/agent.py`, `app/tracing.py`, `app/middleware.py`, `app/logging_config.py`, `docs/alerts.md`, `img/`.
